...
<Latex centered={true} f=" y' = y - t^{2} + 1; \ 0 \le t \le 2;\ y(0) = 0.5;\ h = 0.2" />
...
<Latex centered={true} f=" w_{0} = 0.5" />
...
The final result is <Latex f="y_{rk}(2) = 5.3053" />. If you recall the Euler Method result is <Latex f="y_{e}(2) = 4.8657" />.
